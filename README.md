...
![KidAppetite home page](docs/screenshot-home.png)
...
```
KidAppetite/
├── index.html        App shell, header and footer
├── css/styles.css    Design system and the animated kid
├── js/data.js        Sample recipes, consultants, mothers and meals
├── js/app.js         Store, hash router, views and actions
...
1. Push this folder to the `main` branch of the `KidAppetite` repository.
